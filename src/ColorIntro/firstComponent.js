...
function MyFavoriteColorComponent() {
  ...
  return (
    ...
    <div class="row justify-content-center">
            <div class="col-3 col-md-1 text-center">
              <svg class="svg-icon-1" viewBox="0 0 20 20">
                <path fill="none"
      ...
      <h1 className="intro-title text-center py-5">
        <span className="text_primary">MY</span>{" "}
        <span className="text_accent">FAV</span>{""}
        <span className="text_neutral">COLOR</span>
      </h1>
      <div className="row text-center justify-content-around align-items-center py-5">
        <Card color="primary" hexCode={color1} onChangeColor={changeColor} />
        <Card color="accent" hexCode={color2} onChangeColor={changeColor} />
        <Card color="neutral" hexCode={color3} onChangeColor={changeColor} />
        
      </div>
      <div className="text-center">
        <p>PRESS SPACE BAR, OR</p>
      </div>
      <div className="my-3 d-flex justify-content-center">
        <button
          className="btn btn-outline-primary_A btn-rounded mt-1"
          onClick={newThemeColor}
        >
          CLICK HERE TO TRY A NEW PALLET
        </button>
      </div>
    </div>
    </div>
...
export default MyFavoriteColorComponent;
